...
public class FxJsf2Const {
     ...
     */
    public static final String RESOURCE_COMPONENTS_JS = "js/flexiveComponents.js";

    /**
     * HTML editor javascript resource
     */
    public static final String RESOURCE_HTMLEDITOR_JS = "js/tiny_mce/tiny_mce.js";

    /**
     * Base CSS file for flexive components.
     */
    public static final String RESOURCE_COMPONENTS_CSS = "css/components.css";
