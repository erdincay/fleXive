...
/**
 * JSF2 edit mode render helper implementation.
 * 
 * @author Daniel Lichtenberger (daniel.lichtenberger@flexive.com), UCS - unique computing solutions gmbh (http://www.ucs.at)
 * @version $Rev$
 */
public class Jsf2EditModeHelper extends AbstractEditModeHelper {

    public Jsf2EditModeHelper(AbstractFxValueInput component, String clientId, FxValue value) {
