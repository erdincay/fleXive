 ...
 * @version $Rev$
 */
public class DojoMenu extends UIOutput implements MenuItemContainer, NamingContainer {
    ...
    public void encodeEnd(FacesContext facesContext) throws IOException {
        ...
        // addOnLoad start --->
        MenuWriter.writeMenu(writer, getName(), getName(), DOJO_MENU, DOJO_ITEM, this,
