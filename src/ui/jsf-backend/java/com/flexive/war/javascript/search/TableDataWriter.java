...
abstract class TableDataWriter {
     ...
     *
     * @param dataModel the search result set model
     * @throws IOException if the output could not be written
     */
    public void writeColumns(FxResultSetDataModel dataModel) throws IOException {
        // force loading
        dataModel.setRowIndex(dataModel.getStartRow());
        dataModel.fetchResult(dataModel.getRowIndex());
        // get columns
        writeColumns(getColumns(dataModel.getResult()));
    }
     ...
     *
     * @param dataModel the result set data model containing the search result
     * @throws IOException if the output could not be written
     */
    public abstract void writeRows(FxResultSetDataModel dataModel) throws IOException;
