...
/**
 * The default resource-serving servlets for most web applications,
...
public class DefaultServlet extends HttpServlet {
    ...
    private BasicAttributes newDirAttr(String name, long createdAt, long modifiedAt) {
        BasicAttributes attributes = new BasicAttributes();
        attributes.put(ResourceAttributes.CREATION_DATE, new Date(createdAt));
        //attributes.put(ResourceAttributes.ALTERNATE_CREATION_DATE,new Date(createdAt));
        attributes.put(ResourceAttributes.LAST_MODIFIED, new Date(modifiedAt));
        //attributes.put(ResourceAttributes.ALTERNATE_LAST_MODIFIED,new Date(modifiedAt));
        attributes.put(ResourceAttributes.CONTENT_LENGTH, 0);
        //attributes.put(ResourceAttributes.ALTERNATE_CONTENT_LENGTH,contentLength);
        attributes.put(ResourceAttributes.CONTENT_TYPE, null);
        attributes.put(ResourceAttributes.NAME, name);
        attributes.put(ResourceAttributes.ETAG, null);
        attributes.put(ResourceAttributes.TYPE, null);
        //attributes.put("collection", "false");
        //attributes.put("mimeType", null);
        //attributes.put("name", null);
        //attributes.put("weakETag", null);
        //attributes.put("stongETag", null);
        return attributes;
    }

    private BasicAttributes newFileAttr(String name, long contentLength, long createdAt, long modifiedAt) {
        BasicAttributes attributes = new BasicAttributes();
        attributes.put(ResourceAttributes.CREATION_DATE, new Date(createdAt));
        //attributes.put(ResourceAttributes.ALTERNATE_CREATION_DATE,new Date(createdAt));
        attributes.put(ResourceAttributes.LAST_MODIFIED, new Date(modifiedAt));
        //attributes.put(ResourceAttributes.ALTERNATE_LAST_MODIFIED,new Date(modifiedAt));
        attributes.put(ResourceAttributes.CONTENT_LENGTH, contentLength);
        //attributes.put(ResourceAttributes.ALTERNATE_CONTENT_LENGTH,contentLength);
        attributes.put(ResourceAttributes.CONTENT_TYPE, null);
        attributes.put(ResourceAttributes.NAME, name);
        attributes.put(ResourceAttributes.ETAG, "");
        attributes.put(ResourceAttributes.TYPE, "text/html");
        //attributes.put("collection", "false");
        //attributes.put("mimeType", null);
        //attributes.put("name", null);
        //attributes.put("weakETag", null);
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            listings = Boolean.valueOf(value);
        } catch (Throwable t) {
            ;
        }
        try {
            ...
            if (value != null)
                readOnly = Boolean.valueOf(value);
        } catch (Throwable t) {
            ;
        }
        try {
        ...
        MemoryDirContext hmp = new MemoryDirContext();
        try {
            resources = new ProxyDirContext(new Hashtable(), hmp);
        }
        catch (Exception e) {
            System.out.println("Failed to create memory dir context: " + e.getMessage());
            e.printStackTrace();
        }
    }
...
//        return this.getServletContext().getRealPath("/");
     ...
     * @throws ServletException if a servlets-specified error occurs
     */
     ...
     * Process a POST request for the specified resource.
     *
     * @param req  The servlets request we are processing
     * @param resp The servlets response we are creating
     * @throws IOException      if an input/output error occurs
     * @throws ServletException if a servlets-specified error occurs
     */
    ...
    protected File executePartialPut(HttpServletRequest req, Range range,
        ...
        File tempDir = (File) getServletContext().getAttribute
                ("javax.servlets.context.tempdir");
    ...
    protected void serveResource(HttpServletRequest request,
        ...
        if (debug > 0) {
            if (content)
                log("DefaultServlet.serviceResource:  Serving resource '" +
        ...
        CacheEntry cacheEntry = resources.lookupCache(

                FxWebDavUtils.getDavPath(request)
                //request.getRequestURIWithoutContext().substring(1)
        );
...
//            }
        ...
        if (content) {
            ...
            // Trying to retrieve the servlets output stream
...
//        }
    ...
    protected InputStream renderXml(String contextPath,
                                    ...
                                    InputStream xsltInputStream) throws IOException {
