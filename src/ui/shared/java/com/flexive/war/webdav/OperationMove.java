...
class OperationMove extends Operation {
    ...
    public OperationMove(HttpServletRequest req, HttpServletResponse resp, boolean readonly) {
    ...
    void writeResponse() throws IOException {
        ...
        if (dest == null) {
            ...
            FxWebDavServlet.getDavContext().moveResource(request, path, FxWebDavUtils.decodePath(request, dest));
        }
    }
}
