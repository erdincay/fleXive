 ...
 */
public class FxDavCollection extends FxDavEntry {
     ...
     */
    public FxDavCollection(String displayname, Date creationdate, Date lastmodified) {
        super(true, creationdate, displayname, lastmodified, 0);
    }
