...
public class FxWebDavStatus {
     ...
     * static function.
     *
     * @param httpStatusCode [IN] HTTP or WebDAV status code
     * @return A string with a short descriptive phrase for the
     *         HTTP status code (e.g., "OK").
     */
    public static String getStatusText(int httpStatusCode) {
        if (!mapStatusCodes.containsKey(httpStatusCode)) {
            return "";
        } else {
            return mapStatusCodes.get(httpStatusCode);
        }
    }
