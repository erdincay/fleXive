...
public class ResourceTest {
    ...
    public void resourceTest() throws FxApplicationException {
        ...
        Assert.assertEquals(dc.getResourceKeysMatching("res.test.").size(), 0);
        ...
        Set<String> keys = dc.getResourceKeysMatching("res.test.");
    ...
    public void multipleResourcesTest() throws FxApplicationException {
        ...
        Assert.assertEquals(dc.getResourceKeysMatching("test.mr.").size(), 4);
        Assert.assertEquals(dc.getResourceValues("test.mr.m", FxLanguage.ENGLISH).size(), 2);
        Assert.assertEquals(dc.getResourceKeysMatching("test.mr.m").size(), 2);
        Assert.assertEquals(dc.getResourceValues("test.mr.s", FxLanguage.ENGLISH).size(), 2);
        Assert.assertEquals(dc.getResourceKeysMatching("test.mr.s").size(), 2);
