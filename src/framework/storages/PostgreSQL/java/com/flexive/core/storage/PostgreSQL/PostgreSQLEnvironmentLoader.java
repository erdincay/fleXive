 ...
 */
public class PostgreSQLEnvironmentLoader extends GenericEnvironmentLoader {

    private static final PostgreSQLEnvironmentLoader instance = new PostgreSQLEnvironmentLoader();
