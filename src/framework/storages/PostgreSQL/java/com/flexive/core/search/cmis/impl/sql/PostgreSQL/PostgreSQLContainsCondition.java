 ...
 * @since 3.1
 */
public class PostgreSQLContainsCondition extends GenericContainsCondition {
    private static final PostgreSQLContainsCondition INSTANCE = new PostgreSQLContainsCondition();
    ...
    public static PostgreSQLContainsCondition getInstance() {
        return INSTANCE;
    }
