 ...
 * @since 3.1
 */
public class PostgresColumnReference extends GenericColumnReference {
    private static final String GROUPSEP = "|&#@";
    private static final PostgresColumnReference INSTANCE = new PostgresColumnReference();
    ...
    public static PostgresColumnReference getInstance() {
        return INSTANCE;
    }
