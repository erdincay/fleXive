...
-- Currently Postgres' binary type BYTEA is used to store blob's but is limited to 1GB
...
CREATE TABLE FX_CONTENT_DATA (
  ...
  FDATE1 TIMESTAMP(0) NULL DEFAULT NULL,
  FDATE1_Y INTEGER,
  FDATE1_M SMALLINT,
  FDATE1_D SMALLINT,
  FDATE1_HH SMALLINT,
  FDATE1_MM SMALLINT,
  FDATE1_SS SMALLINT,
  FDATE2 TIMESTAMP(0) NULL DEFAULT NULL,
  FDATE2_Y INTEGER,
  FDATE2_M SMALLINT,
  FDATE2_D SMALLINT,
  FDATE2_HH SMALLINT,
