...
public abstract class FxVideoMetadata extends FxMetadata {
    ...
    /**
     * Retrieve the length of the video file as a String
     *
    ...
    /**
     * Retrieve the length of the video file as a long in microseconds
     *
     * @return the length of the video file in microseconds
     */
