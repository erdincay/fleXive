...
/**
 * Marks an element that can be part of a conditional expression (e.g. x > 5).
 *
 * @author Daniel Lichtenberger (daniel.lichtenberger@flexive.com), UCS - unique computing solutions gmbh (http://www.ucs.at)
 * @version $Rev$
 * @since 3.1
 */
public interface ConditionalExpressionPart<T extends ConditionalExpressionPart> {
     ...
     */
    ConditionColumnMapper<? super T> getConditionColumnMapper(SqlMapperFactory factory);

    /**
     * Returns the table type to be used for this condition.
     *
     * @return  the table type to be used for this condition.
     */
    PropertyResolver.Table getFilterTableType();
