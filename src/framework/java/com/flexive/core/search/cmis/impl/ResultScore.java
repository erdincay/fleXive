...
import com.flexive.core.search.cmis.model.NumericValueFunction;

/**
 * A row SCORE() selected in a CMIS SELECT clause.
 *
 * @author Daniel Lichtenberger (daniel.lichtenberger@flexive.com), UCS - unique computing solutions gmbh (http://www.ucs.at)
 * @version $Rev$
 * @since 3.1
 */
public class ResultScore extends AbstractResultColumn<Double, ResultScore> {
    private final NumericValueFunction function;

    public ResultScore(NumericValueFunction function) {
        this.function = function;
    }

    @Override
    protected ResultScore getThis() {
        return this;
    }
