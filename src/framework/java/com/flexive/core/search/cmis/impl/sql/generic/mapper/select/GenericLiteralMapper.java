 ...
 * @since 3.1
 */
public class GenericLiteralMapper implements ConditionColumnMapper<Literal> {
    private static final GenericLiteralMapper INSTANCE = new GenericLiteralMapper();
    ...
    public static GenericLiteralMapper getInstance() {
        return INSTANCE;
    }
}
