...
public enum FxDataType implements Serializable, SelectableObjectWithName {
    HTML(1, true, true, FxHTML.class),
    String1024(2, true, true, FxString.class),
    Text(3, true, true, FxString.class),
    Number(4, true, false, FxNumber.class),
    LargeNumber(5, true, false, FxLargeNumber.class),
    Float(6, true, false, FxFloat.class),
    Double(7, true, false, FxDouble.class),
    Date(8, true, false, FxDate.class),
    DateTime(9, true, false, FxDateTime.class),
    DateRange(10, true, false, FxDateRange.class),
    DateTimeRange(11, true, false, FxDateTimeRange.class),
    Boolean(12, true, false, FxBoolean.class),
    Binary(13, true, true, FxBinary.class),
    Reference(14, true, false, FxReference.class),
    InlineReference(15, false, false, FxReference.class),
    SelectOne(16, true, true, FxSelectOne.class),
    SelectMany(17, true, true, FxSelectMany.class);

    private boolean initialized;
    private long id;
    private String name;
    private FxString label;
    private boolean singleRowStorage;
    private Class<? extends FxValue> valueClass;
     ...
     */
    FxDataType(long id, boolean singleRowStorage, boolean textType, Class<? extends FxValue> valueClass) {
