...
public enum FxDataType implements Serializable, SelectableObjectWithName {
    ...
    Number(4, true, FxNumber.class),
    LargeNumber(5, true, FxLargeNumber.class),
    Float(6, true, FxFloat.class),
    Double(7, true, FxDouble.class),
    Date(8, true, FxDate.class),
    DateTime(9, true, FxDateTime.class),
    DateRange(10, true, FxDateRange.class),
    DateTimeRange(11, true, FxDateTimeRange.class),
    Boolean(12, true, FxBoolean.class),
    Binary(13, true, FxBinary.class),
    Reference(14, true, FxReference.class),
    InlineReference(15, false, FxReference.class),
    SelectOne(16, true, FxSelectOne.class),
    SelectMany(17, true, FxSelectMany.class);
