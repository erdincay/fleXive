 ...
 */
public enum TypeCategory implements Serializable, ObjectWithLabel {
     ...
     *
     */
    public static TypeCategory getById(int id) throws FxNotFoundException {
        for (TypeCategory cat : TypeCategory.values())
            if (cat.id == id)
                return cat;
        throw new FxNotFoundException("ex.structure.typeCategory.notFound.id", id);
    }
