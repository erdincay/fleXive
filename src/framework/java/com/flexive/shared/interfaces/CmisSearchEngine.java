...
public interface CmisSearchEngine {
     ...
     * @throws com.flexive.shared.exceptions.FxCmisSqlParseException    when the query could not be parsed
     * @throws com.flexive.shared.exceptions.FxCmisQueryException       when the query could not be executed
     */
