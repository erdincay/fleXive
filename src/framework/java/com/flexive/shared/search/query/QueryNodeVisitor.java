...
public interface QueryNodeVisitor {
	/**
	 * Visit an operator node, i.e. a node in the tree with
	 * a query operator (usually AND/OR).
	 * 
	 * @param operatorNode	the operator node visited
	 */
	void visit(QueryOperatorNode operatorNode);
	
	/**
	 * Visit a value node, i.e. a leaf node with some kind of
	 * value attached.
	 * 
	 * @param valueNode	the value node visited
	 */
	 ...
	 * 
	 * @param operatorNode	the parent node of the next visited node
	 */
