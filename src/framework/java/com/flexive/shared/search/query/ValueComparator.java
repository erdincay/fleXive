 ...
 * @version $Rev$
 */
public interface ValueComparator extends ObjectWithLabel {
    /**
     * Returns true if the comparator needs a value ("right-hand-side"). For example,
     * equality needs a value to compare to, while "is null" does not.
     *
     * @return   true if the comparator needs a value ("right-hand-side").
     */
