...
/**
 * Variable binding for scripting.
...
public class FxScriptBinding implements Serializable {
     ...
     */
    public Object getVariable(String name) throws FxNotFoundException {
        Object result = properties.get(name);

        if (result == null && !properties.containsKey(name))
            throw new FxNotFoundException("ex.scripting.binding.property.missing", name);
