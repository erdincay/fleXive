...
import com.flexive.chemistry.webdav.BinaryDocumentResource;
import com.flexive.chemistry.webdav.ChemistryResourceFactory;
import org.apache.chemistry.Document;

/**
 * Add lock support for binary resources.
 *
 * @author Daniel Lichtenberger (daniel.lichtenberger@flexive.com), UCS - unique computing solutions gmbh (http://www.ucs.at)
 * @version $Rev$
 */
public class LockableBinaryDocument extends BinaryDocumentResource implements LockableResource {
    public LockableBinaryDocument(ChemistryResourceFactory resourceFactory, String path, Document object) {
