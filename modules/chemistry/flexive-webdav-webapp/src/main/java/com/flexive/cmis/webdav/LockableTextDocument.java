...
import com.flexive.chemistry.webdav.TextDocumentResource;
 ...
 * @version $Rev$
 */
public class LockableTextDocument extends TextDocumentResource implements LockableResource {
    public LockableTextDocument(ChemistryResourceFactory resourceFactory, String path, Document document) {
