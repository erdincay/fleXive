 ...
 * @version $Rev$
 */
public abstract class DocumentResource extends ObjectResource<Document> {

    protected DocumentResource(ChemistryResourceFactory resourceFactory, String path, Document object) {
