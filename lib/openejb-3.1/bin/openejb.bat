...
REM $Rev: 636963 $ $Date: 2008-03-13 21:40:08 -0500 (Thu, 13 Mar 2008) $
REM================================================

SETLOCAL

set OPENEJB_CORE_JAR=%OPENEJB_HOME%/lib/openejb-core-3.1.jar
set OPENEJB_JAVAAGENT_JAR=%OPENEJB_HOME%/lib/openejb-javaagent-3.1.jar
